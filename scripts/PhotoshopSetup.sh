...
function replacement() {
    ...
    local filelink="file:///home/tsuki/Downloads/replacement.tgz"
...
function install_photoshopSE() {
    ...
    local filelink="https://drive.usercontent.google.com/download?id=1kDVL7xjcyxlQD7DTo5QI71KkXg1sfT1t&authuser=0"
